...
Widget buildBookingActiveJobsCard(BuildContext context, int index, Map<String, dynamic> data) {
    ...
    child: GestureDetector(
      onTap: () {
        showCupertinoModalBottomSheet(
          ...
          elevation: 0.0,
          context: context,
          builder: (context) => BookingSheet(jobID: data['job_id'].toString(),status:false),
        );
      },
      child: Container(
